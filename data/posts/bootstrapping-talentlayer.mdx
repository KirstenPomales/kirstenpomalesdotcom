...
date: 2023-09-06
excerpt: A letter to the TalentLayer open-source community about our next steps to scale the protocol.
---
...
platforms can be anything from self-hosted interfaces to major software marketplace businesses
