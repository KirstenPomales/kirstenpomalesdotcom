---
title: protecting IP in business to business partnerships
date: 2020-10-07
excerpt: The following transcript is from the webinar Protecting Intellectual Property (IP) in Partnerships; a 
...
[Watch the full recorded webinar](https://www.youtube.com/watch?v=orKLMaaf1X4&t=320s) on YouTube.  
  
**During the webinar, we discussed intellectual property implications for three types of partnerships:**

**  

*   A Software Integration Partnership
*   An International Marketing Partnership
...
### Scenario 1: The Software Integration Partnership


From Evan’s slideshow during the Protecting IP During Partnerships webinar.

The integration partnership that we’re going to be discussing in Scenario 1 involves two software companies. One is a company that helps facilitate user account administration and the other is a company that is a marketing automation software as a service (SaaS). So one of the values of integration partnerships is providing additional value for each company’s user bases. So you know these companies decided to enter into an integration partnership. I was hoping Evan and Steve could tell us a little bit about what these companies need to have in mind when engaging in such a partnership. And what they need to watch out for.  
...
#### Due Diligence and NDAs During Partnerships
...
### Scenario 2: The International Partnership
...
#### Basics of B2B Marketing Partnerships
...
#### Issues When Selling to Foreign Governments
...
Steve:  
Your software may appear to be benign, but it may be possible to be used that is less (23:50)\_\_ and there may be laws that you need to comply with in order to offshore that type of information.  
  

#### Dispute Resolution in International Partnerships
...
#### The Benefits of International Marketing Partnerships
...
### Scenario 3: The Blockchain Consortium
...
#### Questions To Ask During Consortium Design
...
#### IP Structuring In DLT Consortia

A typical intellectual property collaboration structure for a deal like this is you have contributors — the five companies — retaining ownership of their intellectual property, which may be code, patents, inventions or know-how. Typically, whatever you’ve developed before the joint venture starts remains yours. But you’ve licensed the joint venture to use the pieces that you’re contributing. You own it but the joint venture has the right to use it. For the safety of the joint venture, that right needs to be more or less (34.48)\_\_ as long as the joint venture doesn’t breach its deal with you. You shouldn’t be able to go take your marbles and go on and leave the joint venture without a key piece of functionality.  
...
#### The Importance of Trust in Multi-Stakeholder Partnerships
...
#### How are IP rights and rights to improvements to IP handled when a consortium member leaves?
